...
const containsTailwindClasses = ($: cheerio.Root): boolean => {
  ...
  const bootstrapClassPattern = /\b(container|row|col|btn|card|alert|badge|breadcrumb|carousel|collapse|dropdown|form|input|modal|nav|navbar|pagination|popover|progress|spinner|toast|tooltip)\b/;

...
const containsTailwindClasses = ($: cheerio.Root): boolean => {
  ...
  const tailwindClassRegex = /\b(tw-|flex|grid|container|bg-|text-|rounded|shadow|m-|p-|w-|h-|z-|justify-|items-|gap-|space-|align-|order-|overflow-|truncate|whitespace-|list-|flex-shrink-|flex-grow-|object-|opacity-|divide-|place-|inset-|transition|transform|scale-|rotate-|translate-|skew-|duration-|ease-|delay-)\b/;
  return classAttributes.some(cls => tailwindClassRegex.test(cls || ''));
};
